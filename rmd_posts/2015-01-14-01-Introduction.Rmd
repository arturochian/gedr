...
To start both R and RStudio requires only firing up RStudio.  RStudio should be available from All Programs at the Start Menu.  Fire up RStudio. 

##Using functions
R is built off of functions.  Using functions follow the basic syntax.
